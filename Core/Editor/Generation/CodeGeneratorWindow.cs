            ...
            if (templateEntries.Count < 1)
            {
                templateEntries.AddRange(new List<TemplateEntry>()
                {
                    ...
                    new TemplateEntry("Variable", new Template(
                        $"Packages/com.theluxgames.soa/Core/Editor/Generation/Templates/VariableTemplate.template",
                        false), true, "Variable"),
                    new TemplateEntry("VariableEditor", new Template(
                        $"Packages/com.theluxgames.soa/Core/Editor/Generation/Templates/VariableEditorTemplate.template",
                        true), true, "Variable"),
                    //References
                    new TemplateEntry("Reference", new Template(
                            $"Packages/com.theluxgames.soa/Core/Editor/Generation/Templates/ReferenceTemplate.template",
                            false),
                        true, "References"),
                    new TemplateEntry("ReferenceDrawer", new Template(
                            $"Packages/com.theluxgames.soa/Core/Editor/Generation/Templates/ReferenceDrawerTemplate.template",
                            true),
                        true, "References"),
                    //Game Events
                    new TemplateEntry("GameEvent", new Template(
                            $"Packages/com.theluxgames.soa/Core/Editor/Generation/Templates/GameEventTemplate.template",
                            false),
                        true, "Game Events"),
                    new TemplateEntry("GameEventListener", new Template(
                            $"Packages/com.theluxgames.soa/Core/Editor/Generation/Templates/GameEventListenerTemplate.template",
                            false),
                        true, "Game Events"),
                    new TemplateEntry("GameEventEditor", new Template(
                            $"Packages/com.theluxgames.soa/Core/Editor/Generation/Templates/GameEventEditorTemplate.template",
                            true),
                        true, "Game Events"),
                    //Unity Events
                    new TemplateEntry("UnityEvents", new Template(
                        $"Packages/com.theluxgames.soa/Core/Editor/Generation/Templates/EventsTemplate.template",
